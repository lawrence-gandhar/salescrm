...
class Lead_questionnaire_model(models.Model):	
    ...
    lead = models.ForeignKey('Leads_tbl', unique=True, db_index = True, on_delete = models.CASCADE)
    qpr = models.TextField(blank= True,)
    lcp = models.TextField(blank= True,)
    lpm = models.TextField(blank= True,)
    inbound_per_month = models.IntegerField(default = 0, db_index = True,)
    outbound_per_month = models.IntegerField(default = 0, db_index = True,)
    inbound_mins_per_call = models.IntegerField(default = 0, db_index = True,)
    outbound_mins_per_call = models.IntegerField(default = 0, db_index = True,)
    ...
    work_hours = models.IntegerField(default = 0, db_index = True,)
    centers_interested = models.TextField(blank = True,)
    pricing = models.IntegerField(default = 0, db_index = True,)
