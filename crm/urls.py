...
try:
    ...
    urlpatterns = [
        ...
        re_path(r'^(?P<usertype>[\w.@+-]+)/leads/edit-lead-step2/(?P<id>[\d]+)/$', views.edit_lead_step_2, name = 'edit-lead-step2'),     
    ...
    urlpatterns = [
        ...
        url(r'^(?P<usertype>[\w.@+-]+)/leads/edit-lead-step2/(?P<id>[\d]+)/$', views.edit_lead_step_2, name = 'edit-lead-step2'),     
